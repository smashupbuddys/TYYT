...
-- Create improved staff performance tracking function without any duration validation
...
DECLARE
  ...
  v_duration integer;
BEGIN
  -- Calculate duration for metrics only (no validation)
  ...
  -- Create performance record without duration validation
...
-- Recreate trigger without any duration checks
