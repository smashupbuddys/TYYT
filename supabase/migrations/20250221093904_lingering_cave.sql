/*
  # Fix staff assignment for video calls

  1. Changes
    - Add staff assignment tracking to video_calls table
    - Add staff availability tracking
    - Add staff notification preferences
    - Add staff assignment history
...
CREATE INDEX idx_video_calls_assigned_staff ON video_calls USING btree ((assigned_staff->>'primary'));
