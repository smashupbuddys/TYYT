...
-- Insert categories with proper 2-letter codes
INSERT INTO markup_settings (type, name, code, markup) VALUES
...
RETURNS SETOF markup_settings AS $$
...
COMMENT ON TABLE markup_settings IS 'Stores markup percentages and codes for manufacturers (e.g., PJ02) and categories (e.g., RG)';
COMMENT ON COLUMN markup_settings.code IS 'Required code - 2 letters for categories, 4 characters for manufacturers (e.g., PJ02)';
