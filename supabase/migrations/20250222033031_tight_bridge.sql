...
BEGIN
  ...
  -- Calculate total items separately to avoid nested aggregates
...
-- Add helpful comment
COMMENT ON FUNCTION complete_sale_v2 IS 'Handles the complete sale process with proper aggregation and validation';