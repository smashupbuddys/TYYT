/*
  # Update Payment Tracking with Staff Notes and Custom Dates

  1. Changes
    - Add payment_notes field to track staff notes about payment delays
    - Add next_follow_up field for custom payment dates
    - Add reminder system for custom payment dates
    - Add staff response tracking with notes
    - Add notification system for custom dates

  2. New Fields
    - payment_notes: Array of staff notes about payment status
    - next_follow_up: Next scheduled payment date with reason
    - payment_reminders: Array of upcoming payment reminders
    - staff_follow_ups: Array of staff follow-up actions
*/
