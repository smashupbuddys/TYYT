...
-- Create improved complete_sale function with valid_until handling
...
BEGIN
  ...
  INSERT INTO quotations (
    ...
    workflow_status,
    quotation_number,
    valid_until -- Add valid_until field
  )
  VALUES (
    p_customer_id,
    p_video_call_id,
    ...
    now() + interval '7 days' -- Set valid_until to 7 days from now
  )
...
-- Add helpful comment
COMMENT ON FUNCTION complete_sale_v2 IS 'Handles the complete sale process with proper valid_until date handling for quotations';